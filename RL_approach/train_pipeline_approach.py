...
from agent_approach import AgentWrapper012, ReplayMemoryWrapper, RolloutWrapper012
...
parser.add_argument("--warmup_times", type=int, default=3, help="times for collecting data only")
...
if __name__ == "__main__":
    ...
    if args.mode == "Train":
        ...
        current_file_path = os.path.abspath(__file__).replace('/train_pipeline_approach.py', '/')
