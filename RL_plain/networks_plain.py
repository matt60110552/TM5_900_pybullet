...
class Feature_extractor(nn.Module):
    ...
    def forward(self, goal_position, joint_degrees, gripper_position, scene_pointcloud):
        x1 = self.goal_position(goal_position)
        x2 = self.joint_degrees(joint_degrees)
        x3 = self.gripper_position(gripper_position)
        x4 = self.scene_pointcloud(scene_pointcloud)
        ...
        output = self.combine(arm_output * x4)
